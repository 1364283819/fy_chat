...
conn.open connstr
sql="SELECT username,grade,times,value,regip,lastip,lasttime FROM reginfo WHERE kill='0' ORDER BY value DESC"
...
<td bgcolor="FF6666"><font color="#FFFFFF">累积分</font></td>
