...
if grade<>10 then Response.Redirect "manerr.asp?id=280"
if inthechat<>"1" and nickname<>"聊天室管理员" then Response.Redirect "manerr.asp?id=281"
username=Server.HTMLEncode(Trim(Request.QueryString("id")))
if username="" then Response.Redirect "manerr.asp?id=282"
n=Year(date())
y=Month(date())
r=Day(date())
s=Hour(time())
...
<div align="center"><font color="#FF0000">【调整级别】</font></div>
<hr noshade size="1" color=009900>
<b>［注意事项］</b> <br>
　　用户名已经找到，以下是该用户名的注册资料，请选择要调整到哪个级别，并输入调整的原因。<br>
...
<hr noshade size="1" color=009900>
<table border="1" cellspacing="0" cellpadding="4" bordercolorlight="#000000" bordercolordark="#FFFFFF" bgcolor="E0E0E0" align="center">
<form method="post" action="pollgradeok.asp">
<tr> 
<td> 
...
<select name="newval">
<%for i=0 to 10%> 
<option value="<%=i%>"<%if i=showgrade then Response.Write " Selected"%>><%=i%> 级</option>
<%next%>
</select>
</td>
</tr>
...
<option value="非常热心!">热心</option>
<option value="表现非常好!">表现好</option>
</select>
</td>
<td> 
<input type="text" name="why" maxlength="60" size="40" value="版主选举时产生的新级别。">
</td>
</tr>
<tr align="center"> 
<td colspan="2">
