...
conn.open connstr
sql="SELECT username,grade,times,value,lasttime,lastip,lastkick FROM reginfo WHERE kill='0' AND lastkick<>''"
...
<font color="#FF0000">【列出曾经被踢过的帐号】</font> <br>
<a href="manacc.asp">返回</a></div>
<hr noshade size="1" color=009900>
<b>［注意事项］</b><br>
　　以下 <font color=red><%=totalrec%></font> 个帐号曾经被踢过。<%if totalrec>0 then%> 
<hr noshade size="1" color=009900>
<div align=center>
...
if page=i then
 ...
 Response.Write " <a href=manaccquerykick.asp?page=" & i & ">[" & i & "]</a>"
end if
next%></div>
<hr noshade size="1" color=009900>
