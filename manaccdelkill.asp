...
conn.open connstr
sql="SELECT username,grade,times,value,regtime,regip,lasttime,lastip,lastkick FROM reginfo WHERE kill='1'"
...
<font color="#FF0000">【清理已自杀的帐号】</font><br>
<a href="manacc.asp">返回</a></div>
<hr noshade size="1" color=009900>
<b>［注意事项］</b><br>
　　以下 <font color=red><%=totalrec%></font> 个帐号已经自杀<%if totalrec>0 then%>，是否清除？　<a href="manaccdelkillok.asp">是(Yes)</a>　<a href="javascript:history.go(-1)">否(No)</a> 
<br>
　　如果想恢复某个帐号，请用“<a href="manaccdelre.asp">恢复帐号</a>”来恢复。
<hr noshade size="1" color=009900>
<div align=center>
...
if page=i then
 ...
 Response.Write " <a href=manaccdelkill.asp?page=" & i & ">[" & i & "]</a>"
end if
next%></div>
<hr noshade size="1" color=009900>
