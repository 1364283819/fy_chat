...
conn.open connstr
sql="SELECT username,grade,times,value,lasttime,lastip FROM reginfo WHERE kill='0' AND leave='0' AND DateDiff('d',lasttime,#" & sj & "#)>30"
...
<font color="#FF0000">【清理３０天未用的帐号】</font>
<br><a href="manacc.asp">返回</a></div>
<hr noshade size="1" color=009900>
<b>［注意事项］</b><br>
　　以下 <font color=red><%=totalrec%></font> 个帐号已经超过３０天未使用<%if totalrec>0 then%>，是否清除？　<a href="manaccdel30ok.asp">是(Yes)</a>　<a href="javascript:history.go(-1)">否(No)</a>
<br>
...
if page=i then
 ...
 Response.Write " <a href=manaccdel30.asp?page=" & i & ">[" & i & "]</a>"
end if
next%></div>
<hr noshade size="1" color=009900>
