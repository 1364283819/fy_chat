...
if Int(newval)>5 and grade<10 then Response.Redirect "manerr.asp?id=247"
...
rs.close
set rs=nothing
gradelog="把 <font color=blue>" & showusername & "</font> 从 <font color=red>" & showgrade & "</font> 级升至 <font color=red>" & newval & "</font> 级！<br><font color=009900>【原因：" & why & "】</font>"
