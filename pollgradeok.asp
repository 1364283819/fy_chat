...
if why="" then Response.Redirect "manerr.asp?id=283"
...
rs.close
set rs=nothing
gradelog="把 <font color=blue>" & showusername & "</font> 从 <font color=red>" & showgrade & "</font> 级调整为 <font color=red>" & newval & "</font> 级！<br><font color=009900>【原因：" & why & "】</font>"
