...
conn.open connstr
sql="SELECT username,grade,times,value,mvalue,lasttime,lastip FROM reginfo WHERE kill='0' AND grade>=6 ORDER BY grade DESC"
...
<font color="#FF0000">【原有版主级别调整】</font> <br>
<a href="poll.asp">返回</a></div>
<hr noshade size="1" color=009900>
<b>［注意事项］</b><br>
　　共有版主帐号 <font color=red><%=totalrec%></font> 个。<%if totalrec>0 then%> 
<hr noshade size="1" color=009900>
<div align=center>
...
if page=i then
 ...
 Response.Write " <a href=manupdowngrade.asp?page=" & i & ">[" & i & "]</a>"
end if
next%></div>
<hr noshade size="1" color=009900>
...
<td><%=show(i+4)%></td>
<td><%=show(i+5)%></td>
<td align="center"><a href="pollgrade.asp?id=<%=server.URLEncode(show(i))%>" target="_blank">Ｇ</a></td>
</tr>
<%next%> 
</table>
<%end if%>
