...
<tr> 
<td width=482><font color=FFFFFF face=Wingdings>1</font><font color=FFFFFF>聊神排行 - <%=chatroomname%></font></td>
<td width=18>
...
<td width="16%" bgcolor="#CCCCCC" align="center"><a href=welcomegb.asp><font color=black>查看留言</font></a></td>
<td align="center" bgcolor="#000000" width="16%"><font color=white>聊神排行</font></td>
<td width="20%">&nbsp;</td>
</tr>
</table>
...
<td>
<iframe name="gb" frameborder="0" scrolling="auto" src="welcomephview.asp?show=0&page=1" height="260" width="470"></iframe>
<table width="98%" border="1" cellspacing="0" bordercolordark="#FFFFFF" bordercolorlight="#000000">
<tr align="center" bgcolor="#FFCC99"> 
<td width="20%"><a href="welcomephview.asp?show=0&page=1" target="gb">[按累积分排名]</a></td>
<td width="20%"><a href="welcomephview.asp?show=1&page=1" target="gb">[按月积分排名]</a></td>
<td width="20%"><a href="welcomephview.asp?show=2&page=1" target="gb">[按次数排名]</a></td>
<td width="20%"><a href="welcomephview.asp?show=3&page=1" target="gb">[按天数排名]</a></td>
</tr>
</table>
</td>
</tr>
