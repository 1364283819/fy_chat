...
if wbqub>0 then
 for i=1 to wbqub step 4
  if CStr(wbq(i+1))=CStr(nickname) then
...
<tr> 
<td width=376><font color=FFFFFF face=Wingdings>*</font><font color=FFFFFF>Web ICQ 1.50 - <%=Application("fy_c_chatroomname")%></font></td>
<td width=18> 
